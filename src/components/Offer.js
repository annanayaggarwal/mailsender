...
const OfferLetterGenerator = () => {
  ...
  const processOfferLetters = async () => {
    ...
    try {
      ...
      const response = await fetch('https://mailsender-2-kfhq.onrender.com/api/generate-letters', {
        method: 'POST',
        body: formData,
      });
      ...
      const emailResponse = await fetch('https://mailsender-2-kfhq.onrender.com/api/send-emails', {
        method: 'POST',
        headers: {
