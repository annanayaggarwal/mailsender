...
const OfferLetterGenerator = () => {
  ...
  const processOfferLetters = async () => {
    ...
    try {
      ...
      const response = await fetch('https://mailsender-ywbn.onrender.com/api/generate-letters', {
        method: 'POST',
        body: formData,
      });
      ...
      const emailResponse = await fetch('https://mailsender-ywbn.onrender.com/api/send-emails', {
        method: 'POST',
        headers: {
